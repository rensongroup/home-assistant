...
- Inherit from `OpenMoticsEntity` and platform base class
...
- Add entity to platform's entity list in `[platform].py`
...
- Platform: `custom_components/openmotics/[platform].py`
