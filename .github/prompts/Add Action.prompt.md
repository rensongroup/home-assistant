...
Create `custom_components/openmotics/service_actions/[action_name].py`:

```python
"""[Action name] service action for OpenMotics Home Assistant integration Beta."""
...
**File:** `custom_components/openmotics/__init__.py`
...
**File:** `custom_components/openmotics/const.py`
...
3. Find service action: `openmotics.[action_name]`
...
- **Domain:** `openmotics`
- **Service actions directory:** `custom_components/openmotics/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/openmotics/services.yaml` (legacy filename)
- **Icons:** `custom_components/openmotics/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/openmotics/translations/*.json` under `services` key (legacy)
