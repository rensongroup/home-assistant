...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `OpenMotics`
...
- Inherit from both platform entity and `OpenMoticsEntity` (order matters)
...
from custom_components.openmotics.sensor import async_setup_entry
...
**Config entry data:** `entry_data: OpenMoticsData = hass.data[DOMAIN][entry.entry_id]`
