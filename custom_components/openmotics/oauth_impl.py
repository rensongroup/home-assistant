...
class OpenMoticsOauth2Implementation(LocalOAuth2Implementation):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        if is_valid_uuid(client_id):
            ...
            doc_url = "https://github.com/rensongroup/home-assistant/blob/master/docs/user/AUTH_CHANGED.md"
            msg = f"Client ID is not a valid UUID, using old OAuth2 endpoints. Please check {doc_url}."
            _LOGGER.warning(msg)
